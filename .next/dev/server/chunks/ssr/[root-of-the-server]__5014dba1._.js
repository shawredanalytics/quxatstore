...
"[project]/src/generated/client/runtime/library.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function Yo() {
    return $.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../");
}
var Nf = "libquery-engine";
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-darwin");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-darwin-arm64");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-debian-openssl-1.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-debian-openssl-1.1.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-debian-openssl-3.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-linux-static-x64");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-linux-static-arm64");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-rhel-openssl-1.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-rhel-openssl-1.1.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query-engine-rhel-openssl-3.0.x");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-darwin.dylib.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-darwin-arm64.dylib.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-debian-openssl-1.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-debian-openssl-1.1.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-debian-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.1.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-linux-arm64-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-linux-musl.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-linux-musl-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-rhel-openssl-1.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-rhel-openssl-1.1.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../libquery_engine-rhel-openssl-3.0.x.so.node");
$.default.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime"), "../query_engine-windows.dll.node");
...
async function za(e, t) {
    ...
    let o = await nt(), s = t.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime/library.js").match(Yd()) === null, c = {
        searchedLocations: i,
...
async function Zd(engineType, config) {
    ...
    ("TURBOPACK compile-time value", "/ROOT/src/generated/client/runtime/library.js").includes("resolveEnginePath") && searchLocations.push(Yo());
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "C:\\Users\\MANIKUMAR\\Desktop\\QuXAT Store\\web\\src\\generated\\client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "C:\\Users\\MANIKUMAR\\Desktop\\QuXAT Store\\web\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "7424aefe80139c89f75b7a1b009a5fbba26efd0ca3509b26a9d8739f455c4022",
    "copyEngine": true
};
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
config.dirname = ("TURBOPACK compile-time value", "/ROOT/src/generated/client");
if (!fs.existsSync(path.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client"), 'schema.prisma'))) {
...
config.runtimeDataModel = JSON.parse("{\"models\":{\"Document\":{\"dbName\":null,\"fields\":[{\"name\":\"id\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":true,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"Int\",\"default\":{\"name\":\"autoincrement\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"title\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"description\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"fileUrl\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"fileName\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"fileType\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"category\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":false,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":false,\"type\":\"String\",\"isGenerated\":false,\"isUpdatedAt\":false},{\"name\":\"uploadedAt\",\"kind\":\"scalar\",\"isList\":false,\"isRequired\":true,\"isUnique\":false,\"isId\":false,\"isReadOnly\":false,\"hasDefaultValue\":true,\"type\":\"DateTime\",\"default\":{\"name\":\"now\",\"args\":[]},\"isGenerated\":false,\"isUpdatedAt\":false}],\"primaryKey\":null,\"uniqueFields\":[],\"uniqueIndexes\":[],\"isGenerated\":false}},\"enums\":{},\"types\":{}}");
defineDmmfProperty(exports.Prisma, config.runtimeDataModel);
config.engineWasm = undefined;
const { warnEnvConflicts } = __turbopack_context__.r("[project]/src/generated/client/runtime/library.js [app-rsc] (ecmascript)");
warnEnvConflicts({
...
path.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client"), "query_engine-windows.dll.node");
path.join(process.cwd(), "src/generated/client/query_engine-windows.dll.node");
// file annotations for bundling tools to include these files
path.join(("TURBOPACK compile-time value", "/ROOT/src/generated/client"), "schema.prisma");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/generated/client/index.js [app-rsc] (ecmascript)");
;
const prismaClientSingleton = ()=>{
    return new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PrismaClient"]();
};
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5014dba1._.js.map